    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.imageContainer}>
          <Image style={styles.logo} source={require('../SendStudentRequest/assets/logo.png')} />
          <Image style={styles.user} source={require('../SendStudentRequest/assets/SayMyName.png')} />
        </View>
      </View>
      ...
      <View style={styles.mainContainer}>
        ...
        <View style={styles.imageBox}>
          <Image style={styles.smallImage} source={require('../SendStudentRequest/assets/enviar.png')} />
        </View>
