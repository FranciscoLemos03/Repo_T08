    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.imageContainer}>
          <Image style={styles.logo} source={require('../VerifyList/assets/logo.png')} />
          <Image style={styles.user} source={require('../VerifyList/assets/SayMyName.png')} />
        </View>
      </View>
      ...
      <View style={styles.mainContainer}>
        ...
        <View style={styles.rectangleContainer}>
          ...
          <View style={styles.rectangleBox}>
            ...
            <Image style={styles.smallImage} source={require('../VerifyList/assets/eye.png')} />
          </View>
